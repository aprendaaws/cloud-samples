...
# Client para assumir a Role
sts_client = boto3.client("sts")

# Credenciais para autenticar os clients - Variáveis de ambiente
assumed_role_object = sts_client.assume_role(
    RoleArn = environ["RoleArn"],
    RoleSessionName = environ["RoleSessionName"],
    ExternalId = environ["ExternalId"]
)

credentials = assumed_role_object['Credentials']

# Client para interação com o S3
